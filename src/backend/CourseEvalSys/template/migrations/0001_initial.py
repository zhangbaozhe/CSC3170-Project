...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Courses',
            fields=[
                ('Course_ID', models.CharField(db_column='Course_ID', max_length=255, primary_key=True, serialize=False, unique=True, verbose_name='Course_id')),
                ...
                ('Is_Valid', models.IntegerField(db_column='Is_Valid', verbose_name='Is_Valid')),
                ('Final_Score', models.IntegerField(db_column='Final_Score', null=True, verbose_name='FinalScore')),
            ],
            options={
                'db_table': 'Courses',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Semester', models.CharField(db_column='Semester', max_length=255, unique=True, verbose_name='Semeste')),
                ('Year', models.IntegerField(db_column='Year', unique=True, verbose_name='Year')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', models.IntegerField(db_column='Status', verbose_name='Status')),
