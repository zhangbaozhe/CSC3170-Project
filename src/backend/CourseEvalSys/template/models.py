...
class Courses(models.Model):
    Course_ID = models.CharField('Course_id',db_column='Course_ID',max_length=255,unique=True,primary_key=True,null = False)
    ...
    Is_Valid = models.IntegerField('Is_Valid',db_column='Is_Valid',null=False)
    Final_Score = models.IntegerField('FinalScore',db_column='Final_Score',null=True)
    class Meta:
        db_table = 'Courses'
...
class Comments(models.Model):
    ...
    Semester = models.CharField('Semeste',db_column='Semester',unique=True,max_length=255,null = False)
    Year = models.IntegerField('Year',db_column='Year',unique=True,null=False)
...
class CommentsLikeStatus(models.Model):
    ...
    CommentID = models.OneToOneField(Comments, related_name='ID_of_Comment',primary_key=True,on_delete=models.CASCADE)
    Status = models.IntegerField('Status',db_column='Status',null=False)
    class Meta:
